function output_structured_edge_detection_images
    ...
    logFile = fullfile('C:\Users\venni\MATLAB\Projects\vennise-fork\MLVcode\vennise-scripts', 'processing_log_SED.txt');
    ...
    for i = 1:length(imageFiles)
        ...
        outputFileName = sprintf('%s_SED.png', fileName(1:end-4));
        outputPath = fullfile(outputFolder, outputFileName);
        imwrite(vecLD, outputPath); % Save as an image
